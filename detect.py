...
#recognize and highlight face with a box
...
#check for "from image" setting
parser=argparse.ArgumentParser()
parser.add_argument('--image')

args=parser.parse_args()

#setup pretrained model variables
...
#setup lists of possible age groups and genders
